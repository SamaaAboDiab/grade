            ...
            <div class="nav_box">
                <div class="nav_btns">
                    ...
                    <div class="login_toggle">
                        <a href="sginup.php" class="login_link">
    ...
    <div class="form_account">
        <div class="form-container container">
            ...
            <div class=" input-wrapper">
                <input type="text" placeholder="أسم المستخدم" required class=" input input-user">
        ...
        <div class="input-wrapper">
            <input type="password" placeholder="كلمة المرور" required class="input">
            <i class="fa-regular fa-eye-slash icon_form showPss"></i>
        </div>

        <div class="input-wrapper m-none">
            <input type="password" placeholder="تأكيد كلمة المرور" required class="input input-pass">
            <i class="fa-regular fa-eye-slash icon_form showPss"></i>
        </div>

        <div class="box-accept">
            <input type="checkbox" name="accept" value="yes" id="accept">
